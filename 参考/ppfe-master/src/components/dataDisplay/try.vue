...
export default {
    ...
    methods: {
        ...
        //         .then(req => {
        //             if (req.success) {
        //                 this.value.leftList = req.result.otherRoleStaff;
        //                 this.value.rightList = req.result.roleStaff;
        //             } else {
        ...
        // //选中一个
        // checkedOne(index) {
        //     if (this.isadmin && this.value.rightList.length >= 1) {
        //         this.$message.info('管理员只能转让给一个员工！');
        //         return false;
        //     } else {
