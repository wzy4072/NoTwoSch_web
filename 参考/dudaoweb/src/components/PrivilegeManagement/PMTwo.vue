      ...
      <div class="ins-page-con">
         ...
         <el-row :gutter="8" class="ins-s-hf">
            <el-col :span="12" class="ins-s-hf">
               <div class="grid-content bg-purple ins-s-hf">
                  <div class="item-con">
                     ...
                     <div class="item-content">
                        <ul>
                           <li :class="{'selected':item.selected}" :key="key" v-for="(item,key) in roleList" @click="changeRole(item)">
                              <div style="width:200px;height:100%;text-align:center;float:left;" v-text="item.roleName"></div>
               ...
               <div class="grid-content bg-purple ins-s-hf">
                  <div class="item-con">
                     ...
                     <div class="item-head">
                        ...
                        <div style="width:200px;text-align:center;float:right;border-left:1px solid #e6e6e6;">岗位/年级班级</div>
                     </div>
                     <div class="item-content">
                        <ul>
                           <li v-for="(item,key) in personList" :key="key">
                              ...
                              <div style="width:200px;height:100%;text-align:center;float:right;line-height: 38px;border-left:1px solid #e6e6e6;">
                                 <span v-text="!item.dictValue?(item.gradeName+item.className):item.dictValue"></span>
                              </div>
                           </li>
                        </ul>
                     </div>
                        ...
                        <div class="set-item">
                           ...
                           <div class="item-list-con">
                              <div class="list-con-title">
                                 <div style="width:35%;float:left;text-align:center;">姓名</div><div style="width:45%;float:left;text-align:center;">岗位/年级班级</div><div style="width:20%;float:left;text-align:center;">操作</div>
                              </div>
                              <ul>
                                 <li v-show="item.searched" :key="key" v-for="(item,key) in personList_c" style="padding: 5px 0;overflow:hidden;border-bottom:1px solid #e6e6e6;">
                                    ...
                                    <span v-text="item.dictValue?item.dictValue:(item.gradeName+item.className)"></span>
