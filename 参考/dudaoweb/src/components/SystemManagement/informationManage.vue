...
<template>
    <div class="ins-container">
        <div class="ins-page-top">
            <!-- page title -->
            <returnBtn :title="'系统职务信息管理'"></returnBtn>
        </div>
        ...
        <div class="ins-page-main">
            ...
            <div class="ins-table divide">
                ...
                <div class="ins-tab-con">
                    <!-- 表格内容 -->
                    <el-table :data="tableData" ref="multipleTable" @selection-change="check" border height="100%" id="a" stripe="" style="width: 100%;height:100%">
                        <el-table-column type="selection" align="center" width="50"></el-table-column>
                        <el-table-column align="center" type="index" label="序号"  v-if="scrColumn[0].selected" width="80">
                        </el-table-column>
                        <el-table-column align="center" label="职务名称" prop="dictValue" sortable v-if="scrColumn[1].selected">
                            <template slot-scope="scope">
                                <el-button v-if="fixation.indexOf(scope.row.dictValue)===-1" type="text" class="ins-s-p0" size="small" @click="name_function(scope.row,2)">{{scope.row.dictValue}}</el-button>
            ...
            <el-dialog :title="dialogTitle" :visible.sync="dialogVisible" width="450px" :before-close="cancel">
                 <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px">
                    <el-form-item label="职务名称：" prop="dutyName">
                        <el-input :autosize="{ minRows: 4, maxRows: 8}" :type="type==1?'textarea':'input'" v-model="ruleForm.dutyName" placeholder="请输入职务名称"></el-input>
                    </el-form-item>
          ...
          <el-dialog title="操作提示" :visible.sync="deletDialog" width="30%">
            <span><p>确认删除该职务？</p><p>此操作不可撤销</p></span>
            <span slot="footer" class="dialog-footer">
...
<script src="./js/informationManage.js"></script>
