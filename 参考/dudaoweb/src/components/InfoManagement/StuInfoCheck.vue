            ...
            <div class="ins-page-type type1">
                <div class="ins-page-btn">
                    <div class="ins-opa-btn">
                        <el-button type="warning" size="small" v-if="isEdit==false" @click="edit()">编辑</el-button>
                        <el-button type="success" size="small" v-if="isEdit==true" @click="submitForm('AForm')">保存</el-button>
                        <el-button type="primary " size="small" v-if="isEdit==true" @click="resetForm('AForm')">取消</el-button>
                    </div>
                </div>
                <!-- 页面主体 -->
                                ...
                                <el-form :model="ruleForm" :rules="rules" ref="AForm" label-width="145px">
                                    ...
                                    <el-row>
                                        <el-col :span="12">
                                            <div class="item-content left-item">
                                                ...
                                                <el-form-item label="姓名：" prop="studentName">
                                                    <el-input v-show="isEdit" v-model="ruleForm.studentName"></el-input>
                                                    <span v-show="!isEdit" v-text='ruleForm.studentName'></span>
                                                </el-form-item>
                                                <!-- 性别 -->
                                                <el-form-item label="性别：" prop="studentGenderName">
                                                    <el-radio-group  class="radioBox" v-show="isEdit" v-model="ruleForm.studentGenderName" size="small">
                                                ...
                                                <el-form-item label="班级座号：">
                                                    <el-input v-show="isEdit" v-model="ruleForm.seatNum"></el-input>
                                                    <span v-show="!isEdit" v-text='ruleForm.seatNum'></span>
                                                </el-form-item>
                                                <!-- 入学日期 -->
                                                <el-form-item label="入学日期：" prop="entranceDateStr">
                                                    <el-date-picker v-show="isEdit" type="date" value-format="yyyy-MM-dd" placeholder="选择日期" v-model="ruleForm.entranceDateStr" style="width: 100%;"></el-date-picker>
                                                    <span v-show="!isEdit" v-text='ruleForm.entranceDateStr'></span>
                                                </el-form-item>
                                                <!-- 入学代码 -->
                                        ...
                                        <el-col :span="12">
                                            ...
                                            <!-- 子女人数 -->
                                            <el-form-item label="子女人数：" prop="childrenListSize">
...
<script src="./js/StuInfoCheck.js"></script>
