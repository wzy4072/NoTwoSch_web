<!-- 章程管理 督导员 -->
<style scoped>
   #tab .el-icon-star-off.active,.history .el-icon-star-off.active{
      color:#ffa400;
   }
   #tab .el-icon-error{
      color:#F56C6C;
      ...
      <div class="ins-page-type type1">
         <div class="ins-page-btn">
            <div class="ins-opa-btn">
               <el-button size="small" type="success" @click="tableOpa(2)">
                  <span class="el-icon-edit"></span><span>更新资料</span>
               </el-button>
            </div>
         </div>
      <div class="ins-page-main">
         <div class="ins-table divide">
            ...
            <div class="ins-tab-con">
               <el-table :data="tableData" border height="100%" id="tab" stripe style="height:100%;width:100%;">
                  <el-table-column align="center" show-overflow-tooltip label="资料名称" sortable>
                  ...
                  <el-table-column align="center" show-overflow-tooltip label="编辑者" prop="sendName" sortable>
                  </el-table-column>
                  <el-table-column align="left" label="操作" fixed="right" width="320">
                     <template slot-scope="scope">
                        <el-row>
                           <el-button icon="el-icon-download" plain size="mini" type="success" @click="name_function2(scope.row)">模板下载</el-button>
                           <template v-if="scope.row.noticeStatus">
                             <el-button icon="el-icon-edit" v-if="scope.row.noticeStatus==2" plain size="mini" type="success" @click="tableOpa(1,scope.row)">编辑</el-button>
                             <el-button icon="el-icon-view" v-if="scope.row.noticeStatus==3" plain size="mini" type="success" @click="tableOpa(3,scope.row)">查看</el-button>
                             <el-button icon="el-icon-document" plain size="mini" type="success" @click="tableOpa(4,scope.row)">历史版本</el-button>
                           </template>
                        </el-row>
                     </template>
                  </el-table-column>
         ...
         <el-dialog title="历史版本" :visible.sync="historyLayer" width="70%">
             <div class="ins-table">
                ...
                <div class="ins-tab-con">
                    <el-table class="history" border height="300px" :data="currRow.historyData" stripe>
               ...
               <el-table-column align="center" label="操作" sortable width="100">
                  <template slot-scope="scope">
                      <el-button v-if="scope.row.noticeStatus" icon="el-icon-view" plain size="mini" type="success" @click="tableOpa(0,scope.row)">查看</el-button>
                  </template>
               </el-table-column>
            </el-table>
                </div>
            ...
            <span slot="footer" class="dialog-footer">
               <el-button type="primary" size="small" @click="historyLayer=false">确认</el-button>
            </span>
         </el-dialog>
         <!-- 章程详情弹框 -->
         <el-dialog title="资料详细信息" :visible.sync="detailsLayer" width="50%">
            ...
            <span slot="footer" class="dialog-footer">
               <el-button type="primary" size="small" @click="detailsLayer=false">确认</el-button>
            </span>
         </el-dialog>
